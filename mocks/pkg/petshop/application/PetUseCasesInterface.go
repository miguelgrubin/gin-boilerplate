...
func (_m *PetUseCasesInterface) Creator(_a0 application.PetCreatorParams) (domain.Pet, error) {
	...
	var r0 domain.Pet
	var r1 error
	if rf, ok := ret.Get(0).(func(application.PetCreatorParams) (domain.Pet, error)); ok {
		return rf(_a0)
	}
...
//   - _a0 application.PetCreatorParams
...
func (_c *PetUseCasesInterface_Creator_Call) Run(run func(_a0 application.PetCreatorParams)) *PetUseCasesInterface_Creator_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(application.PetCreatorParams))
	})
	return _c
}
...
func (_c *PetUseCasesInterface_Creator_Call) RunAndReturn(run func(application.PetCreatorParams) (domain.Pet, error)) *PetUseCasesInterface_Creator_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *PetUseCasesInterface) Finder(_a0 application.PetFinderParams) ([]domain.Pet, error) {
	...
	var r0 []domain.Pet
	var r1 error
	if rf, ok := ret.Get(0).(func(application.PetFinderParams) ([]domain.Pet, error)); ok {
		return rf(_a0)
	}
...
//   - _a0 application.PetFinderParams
...
func (_c *PetUseCasesInterface_Finder_Call) Run(run func(_a0 application.PetFinderParams)) *PetUseCasesInterface_Finder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(application.PetFinderParams))
	})
	return _c
}
...
func (_c *PetUseCasesInterface_Finder_Call) RunAndReturn(run func(application.PetFinderParams) ([]domain.Pet, error)) *PetUseCasesInterface_Finder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *PetUseCasesInterface) Updater(_a0 shared.EntityID, _a1 application.PetUpdatersParams) (domain.Pet, error) {
	...
	var r0 domain.Pet
	var r1 error
	if rf, ok := ret.Get(0).(func(shared.EntityID, application.PetUpdatersParams) (domain.Pet, error)); ok {
		return rf(_a0, _a1)
	}
...
//   - _a0 shared.EntityID
//   - _a1 application.PetUpdatersParams
...
func (_c *PetUseCasesInterface_Updater_Call) Run(run func(_a0 shared.EntityID, _a1 application.PetUpdatersParams)) *PetUseCasesInterface_Updater_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(shared.EntityID), args[1].(application.PetUpdatersParams))
	})
	return _c
}
...
func (_c *PetUseCasesInterface_Updater_Call) RunAndReturn(run func(shared.EntityID, application.PetUpdatersParams) (domain.Pet, error)) *PetUseCasesInterface_Updater_Call {
	_c.Call.Return(run)
	return _c
}
